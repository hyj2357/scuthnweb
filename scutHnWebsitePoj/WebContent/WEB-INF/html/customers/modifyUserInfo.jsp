	...
	<body onload="createCode()">	
				...
				<div class="main">
					<!--start-Modify-form-->
						...
						<form action="userInfoModifyAction" method="post">
                              
							    <div>								
						  		    <h4>QQ号码</h4>						  		    
						  		    <%
						  		       out.print("<input type=\"text\" value="+((Customer)session.getAttribute("customer")).getCustomer_qq()
								    ...
								    <h4>电子邮箱</h4>
								    <%
						  		       out.print("<input type=\"text\" value="+((Customer)session.getAttribute("customer")).getCustomer_email()
							    ...
							    <div>
						  		     <h4>年级</h4>
									 <%
						  		       out.print("<input type=\"text\" value="+((Customer)session.getAttribute("customer")).getCustomer_grade()
								     ...
								     <h4>专业</h4>
									 <%
						  		       out.print("<input type=\"text\" value="+((Customer)session.getAttribute("customer")).getCustomer_major()
						  		 ...
						  		 <div>						
								     <h4>手机号</h4>
									 <%
						  		       out.print("<input type=\"text\" value="+((Customer)session.getAttribute("customer")).getCustomer_phone()
						             ...
						             <h4>宿舍号</h4>
								     <%
						  		       out.print("<input type=\"text\" value="+((Customer)session.getAttribute("customer")).getCustomer_room()

				...
				<div class="main">
					<div class="wrap">
					   <div class="Login">
						...
						<form action="userIDLoginAction" method="post">								<div>
									<h4>用户id</h4>
						  			<input type="text" name="id"  onblur="if(this.value.length>=2&&this.value.length<=4){logname_inform_wrong.style.display='none'; logname_inform_right.style.display='block';} else{logname_inform_right.style.display='none'; logname_inform_wrong.style.display='block';}" >
						  		...
						  		<div>
						  		<h4>密码</h4>
								<input  type="password" name="customer_password"  onblur="if(this.value.length>=5&&this.value.length<=20){logpwd_inform_right.style.display='block'; logpwd_inform_wrong.style.display='none';} else{logpwd_inform_right.style.display='none'; logpwd_inform_wrong.style.display='block';}">

		...
		<table class="table table-striped table-hover">
	      ...
	      <tbody>	        
	        <tr>
	          <td>1</td>
	          <td>上线活动列表</td>
	          <td class="text-right"><a href="checkAllActAction" class="btn btn-info"><i class="fa">=></i></a></td>
	        </tr>
	        <tr>
	          <td>2</td>
	          <td>查看所参加的活动</td>
	          <td class="text-right"><a href="checkTakePartInAction" class="btn btn-info"><i class="fa">=></i></a></td>
	        </tr>	        
	      </tbody>
	    </table>

		...
		<table class="table table-striped table-hover">
	      ...
	      <tbody>	        
	        <tr>
	          <td>1</td>
	          <td>已发送消息</td>
	          <td class="text-right"><a href=checkPublisherMessagesAction class="btn btn-info"><i class="fa">=></i></a></td>
	        </tr>
	        <tr>
	          <td>2</td>
	          <td>接收消息</td>
	          <td class="text-right"><a href="checkReceiverMessagesAction" class="btn btn-info"><i class="fa">=></i></a></td>
	        </tr>	        
	      </tbody>
	    </table>

...
<body class="templatemo-bg-gray">
	...
	<div class="container center-block templatemo-form-list-container templatemo-container">
		...
		<table class="table table-striped table-hover">
	      ...
	      <% 
	      Map<String,String> event_map = (Map<String,String>)session.getAttribute("event_map");
	      Set<String> itrSet = event_map.keySet();
	      for(String itr:itrSet)
	        out.print("<tbody><tr><td><a href=\"#\">"+itr+"</a></td>"+"<td class=\"text-right\"><a href=\""+(String)event_map.get(itr)+"\" class=\"btn btn-info\">点击查看详细活动信息</a></td></tr></tbody><tbody>");
	      %>	        
	    </table>
		</div>
	</div>
